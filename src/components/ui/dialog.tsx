...
import { cleanupInteractivityBlocks } from "@/components/PageInteractivityGuard"
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, disableAutoFocus = false, instantOpen = false, ...props }, ref) => {
  React.useEffect(() => {
    // Cleanup on unmount (when dialog closes)
    return () => {
      setTimeout(cleanupInteractivityBlocks, 50);
    };
  }, []);
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          instantOpen 
            ? "data-[state=open]:opacity-100 transition-opacity duration-100" 
