-- Phase 1: Database Schema Extensions for Advanced Table Groups - Fixed
...
-- 6. Drop and recreate get_available_table_groups_with_status with extended return type
DROP FUNCTION IF EXISTS get_available_table_groups_with_status(uuid);
