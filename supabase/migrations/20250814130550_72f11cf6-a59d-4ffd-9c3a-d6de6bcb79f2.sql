-- Update the existing company_settings record to link it to the correct company
UPDATE public.company_settings 
SET company_id = 'e95d96dd-fbd6-4606-a7de-4ce9a6c3a731'::uuid
WHERE id = 'a28d8844-b59a-4fa0-ae0e-50c85f4c5d8b'::uuid;

-- Create foreign key constraint to companies table (if it doesn't exist)
DO $$
BEGIN
    BEGIN
...
-- Add unique constraint to ensure one settings record per company (if it doesn't exist)
DO $$
BEGIN
    BEGIN
