...
CREATE UNIQUE INDEX IF NOT EXISTS idx_companies_owner_pin ON public.companies(owner_pin) 
WHERE owner_pin IS NOT NULL;

-- Create the updated authenticate_by_pin function with new return structure
