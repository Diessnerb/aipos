-- Update check_comprehensive_availability function to limit suggestions to 2, find closer times, and use shorter messages
...
DECLARE
  ...
  direction integer := 1; -- 1 for forward, -1 for backward
BEGIN
