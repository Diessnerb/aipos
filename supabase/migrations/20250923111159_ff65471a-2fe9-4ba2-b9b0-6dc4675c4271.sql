-- Clean up overloaded RPCs and create canonical versions (with proper parameter ordering)
...
-- 2) Recreate secure_table_insert with required params first, defaults last
...
-- 3) Recreate secure_table_update with required parameter first, defaults last
