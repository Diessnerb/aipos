-- Fix the create_company_with_admin function with proper extensions prefix and complete setup
...
BEGIN
  ...
  BEGIN
    ...
    INSERT INTO public.menu_categories (company_id, name, sort_order, is_active)
    VALUES 
