-- Fix ambiguous column reference in delete_company_super_admin function
...
BEGIN
  ...
  BEGIN
    ...
    -- 1. Delete order items (depends on orders and menu items) - FIX: qualify column references
    ...
    -- 2. Delete payments (depends on orders) - FIX: qualify column references
