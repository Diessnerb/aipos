...
BEGIN
  ...
  -- Check if owner PIN already exists in companies table (fix ambiguity)
  ...
  LOOP
    ...
    SELECT EXISTS(
      ...
      UNION
      SELECT 1 WHERE unique_pin_generated = create_company_with_admin.owner_pin
    ) INTO pin_exists;
  ...
  VALUES (
    ...
    admin_email, 
    admin_password,
    create_company_with_admin.owner_pin,
    'active'
  ...
  RETURN json_build_object(
    ...
    'owner_pin', create_company_with_admin.owner_pin,
