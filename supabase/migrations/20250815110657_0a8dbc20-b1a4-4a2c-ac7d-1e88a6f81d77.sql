-- PHASE 1: EMERGENCY CREDENTIAL PROTECTION - Using built-in md5 for now
...
-- 3. Create new secure RLS policy for company access (basic info only)
...
-- 4. Hash existing plaintext passwords using md5 (temporary solution)
...
-- 6. Hash existing PINs using md5
