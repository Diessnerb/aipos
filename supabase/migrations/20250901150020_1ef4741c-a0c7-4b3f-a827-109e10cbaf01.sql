-- Drop existing functions if they exist and create new secure RPC functions for PIN users

-- Drop existing functions
DROP FUNCTION IF EXISTS public.secure_table_insert(integer,text,integer,text,text,text,boolean,text,uuid);
DROP FUNCTION IF EXISTS public.secure_table_update(uuid,integer,text,integer,text,text,text,boolean,text);
