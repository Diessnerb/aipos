-- Drop all versions of secure_table_update function using simpler approach
DROP FUNCTION IF EXISTS public.secure_table_update CASCADE;

-- Create the single canonical version that handles can_combine
