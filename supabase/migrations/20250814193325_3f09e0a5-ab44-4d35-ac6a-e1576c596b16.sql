-- Fix the create_company_with_admin function - remove manual id assignment in company_settings
...
BEGIN
  ...
  BEGIN
    ...
    -- Create default company settings - FIXED: Let id auto-generate, only set company_id
    ...
    -- Create default menu categories - use display_order instead of sort_order
