-- Fix check_comprehensive_availability function to use correct table group joins
...
BEGIN
  ...
  -- Calculate available table group capacity (FIXED JOIN)
  ...
  FROM (
    ...
    JOIN public.tables t ON t.id = tgm.table_id AND t.company_id = tg.company_id
