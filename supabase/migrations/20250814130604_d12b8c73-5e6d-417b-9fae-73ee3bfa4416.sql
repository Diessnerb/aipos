...
WHERE id = 'a28d8844-b59a-4fa0-ae0e-50c85f4c5d8b' AND company_id IS NULL;
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE constraint_name = 'fk_company_settings_company_id'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'unique_company_settings_per_company'
    ) THEN
        ALTER TABLE public.company_settings 
