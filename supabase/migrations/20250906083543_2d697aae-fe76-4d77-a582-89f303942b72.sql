-- Drop and recreate function to remove total_seats from return as it's misleading due to seat loss when combining tables
DROP FUNCTION IF EXISTS public.get_available_table_groups_with_status(uuid);
