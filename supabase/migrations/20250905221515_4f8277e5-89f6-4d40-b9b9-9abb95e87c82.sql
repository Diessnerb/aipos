-- Drop and recreate secure_tables_list function to include missing can_combine and max_combine_size columns
DROP FUNCTION IF EXISTS public.secure_tables_list(uuid);

CREATE FUNCTION public.secure_tables_list(p_company_id uuid)
