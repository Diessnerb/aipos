-- Drop all existing overloads of secure_table_update to avoid conflicts
DROP FUNCTION IF EXISTS public.secure_table_update(uuid, integer, text, integer, text, text, text, text, boolean, text, boolean, boolean, integer, integer, jsonb, boolean, boolean, text, text, boolean, boolean, boolean, boolean, boolean, boolean, text);
DROP FUNCTION IF EXISTS public.secure_table_update(uuid, integer, text, integer, text, text, text, text, boolean, text, boolean, boolean, integer, integer, jsonb, boolean, boolean, text, text, boolean, boolean, boolean, boolean, boolean, boolean, text, double precision, double precision, double precision, integer);

-- Create a single canonical version of secure_table_update with proper types
