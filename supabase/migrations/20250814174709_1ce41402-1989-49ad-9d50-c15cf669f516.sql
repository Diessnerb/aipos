-- Drop and recreate RPC functions to exclude super admin users from company user listings

-- Drop existing function first
DROP FUNCTION IF EXISTS public.get_all_users_cross_company();

-- Recreate get_all_users_cross_company to exclude super admin users
