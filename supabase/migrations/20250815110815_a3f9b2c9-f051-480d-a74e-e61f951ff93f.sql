-- PHASE 1: EMERGENCY CREDENTIAL PROTECTION - Fix existing issues
...
DROP POLICY IF EXISTS "Company users can view their company menu items" ON menu_items;
DROP POLICY IF EXISTS "Company users can view their company menu categories" ON menu_categories;

-- Create company-scoped menu access policies
...
DROP POLICY IF EXISTS "Super admins can view auth attempts" ON auth_attempts;
